...
ItemRecommendation:
{
  ...
  "matchup_delta": number,   // How much this matchup shifts THIS item's value.
                             // Use overall matchup_delta as baseline, then adjust:
                             // +0.02–0.05 if item specifically counters enemy abilities
                             // -0.02–0.05 if item is weaker into this lineup
  "confidence": "high" | "medium" | "low"
                             // high = top-3 by purchase count, medium = top-10, low = otherwise
}
